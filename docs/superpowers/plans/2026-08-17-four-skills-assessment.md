...
1. Which ~6 activities become Workshop tier and which ~20 become Recommended (blocks Task 12 Step 5 from completing fully).
2. Whether the extra-credit subset disappears entirely or survives as a formality.
