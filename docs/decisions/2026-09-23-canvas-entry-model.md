...
Status: implemented in #259, part of the fall assignment feedback cycle (#258). Rubric paths below are the TSVs #284 replaced with CSVs, and the contribution Half band is gone since #305 (Full, Partial, Zero). Rules 3 and 4's survey exception was reversed by #300: every survey entry is 100 points in a group of its own, and names a rubric.
