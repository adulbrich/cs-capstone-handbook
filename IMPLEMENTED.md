...
5. Week numbers assume the standard term calendar; verify against the actual academic calendar before publishing (#49, and a term-setup checkbox since #47). Expo is confirmed as spring week 10 (instructor, 2026-08-19), which is what sets the spring defense window at weeks 7 to 10.
