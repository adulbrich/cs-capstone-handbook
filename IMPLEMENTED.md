...
5. ~~Week numbers assume the standard term calendar; verify against the actual academic calendar before publishing (#49, and a term-setup checkbox since #47).~~ **Verified 2026-09-13 against the registrar's 2026-27 calendar** (#49). Fall: classes Wed Sep 23 to Fri Dec 4, finals Dec 7 to 11, so the term has eleven instructional weeks; counting the partial first week as week 0, week 1 is Sep 28 to Oct 2, **week 9 is Nov 23 to 27 with Thanksgiving on Thu and Fri, and week 10 is Nov 30 to Dec 4, a full week**. Veterans Day (Wed Nov 11) falls in week 7. Winter: classes Mon Jan 4 to Fri Mar 12, finals Mar 15 to 19; MLK Day (Mon Jan 18) is week 3. Spring: classes Mon Mar 29 to Fri Jun 4, finals Jun 7 to 11; Memorial Day (Mon May 31) is week 10, Commencement Sat Jun 12. Consequence for #25: the three-day week is week 9 (Term Retrospective), not week 10 (Sprint Note 4, Repo Checkpoint 2, demo day); #25's premise inverts and stays the instructor's call. Expo is confirmed as spring week 10 (instructor, 2026-08-19); the spring defense window is weeks 7 to 9 like every term (#31).
