...
- `scripts/validate-activity-tiers.mjs` reconciles badges against assignment links, because the tier is decided in one file and displayed in another. Wired into CI and pre-commit. Tiers now: **8 Workshop, 54 Recommended, 58 Library, 120 total**.
