...
The primary vehicle is the [RFC](/assignments/rfc/), written once in fall and once in winter, each with a full draft, cross-team feedback, and revision cycle. Where each outcome is evidenced is documented on the [outcome mapping page](/learning-objectives/mapping/).
