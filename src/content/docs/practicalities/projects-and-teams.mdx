...
- **Student proposals.** A student may submit a project of any outcome type, but it needs a project partner or an approved mentor. If it is accepted, the student and any teammates named in the proposal are assigned to it automatically; it may not appear in the public list at all.
