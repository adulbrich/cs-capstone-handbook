...
- **Outcome type.** Every project has one of four [outcome types](/practicalities/types/) (FOSS, Research, Consultancy, New Product or Game), which picks the shipping playbook; a submission does not have to name one, because the team and the project partner agree it after teams are announced. Every project is [scored on who ran the software](/assignments/project-partner-evaluation/#spring), whatever its outcome type.
