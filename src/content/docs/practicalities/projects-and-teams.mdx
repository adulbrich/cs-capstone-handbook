...
- **Outcome type.** Every project has one of four [outcome types](/practicalities/types/) (FOSS, Research, Consultancy, New Product or Game), which picks the shipping playbook; the team names it in its Definition of Shipped. Every project is [scored on who ran the software](/assignments/project-partner-evaluation/#spring), whatever its outcome type.
