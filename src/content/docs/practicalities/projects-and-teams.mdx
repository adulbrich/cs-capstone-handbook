...
- **Deadline.** Submissions close when fall term starts. Submit during the summer so we have time to review it and, if needed, help you refine it.
- **Category.** Every project belongs to one of the four [project categories](/practicalities/categories/), and the category decides how the project partner [evaluates the outcome](/assignments/project-partner-evaluation/#verification-and-validation).
...
Students bid on projects in a survey in fall week 0, and the instruction team announces the teams in fall week 1; the [schedule](/introduction/series/#schedule) lays this out with everything else. We aim for teams of 3 to 4 students; real teams range from 2 to 5 depending on enrollment and project needs, and the instructors balance skills and preferences across all teams.
...
A student who changes teams is assessed on their contributions to each team for the time they were on it; the [assignments overview](/assignments/introduction/#nda-projects) states the roster-change rule. Neither team's grade should suffer for a change the instructors approved.
