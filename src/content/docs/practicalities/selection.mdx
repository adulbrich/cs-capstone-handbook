...
:::note
If, as a student, you have your own project idea (it can be of any category, but you need a project partner or mentor), you can [submit the project](https://eecs.engineering.oregonstate.edu/capstone/submission/pages/) for review before early September. If accepted, you'll be able to work on that project with some of your peers.
:::
...
:::caution
Students should discuss how the project will be evaluated at the end of each term. Our project partners receive a survey with very specific rubrics. Their evaluation is worth 25% of the final grade.
:::

Once you talk to your team, the first step is **to reach out to and meet your project partner or mentor**. Start from the [introduction email template](/email-template.txt). Through them, get clarifications on the project, expectations, deliverables, and start figuring out the timeline. Make them aware of the main assignments this term as well as the grading rubrics. All the information is available in the [Assignments section](/assignments/introduction/) of this handbook, which is the source of truth; Canvas mirrors it.
