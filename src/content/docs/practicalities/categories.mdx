...
<LinkCard
  ...
  href="/assignments/project-partner-evaluation/#verification-and-validation"
/>
<LinkCard
  title="What does 'shipped' mean for your category?"
  description="The per-category path to a shipped project, from FOSS patches to published research."
...
:::note
Some projects may not fit neatly into these categories. Hence, students and their project partners or mentors can set custom expectations for the project outcomes.
:::
...
<Tabs syncKey="trio">
  <TabItem label="Benefits" icon="rocket">
    - **Real users:** The ladder for this category counts people who do not know you using the thing, and nothing teaches faster than watching a stranger hit your onboarding flow.
    - **Creative Freedom:** Push the boundaries of your creativity to develop a new product.
    - **Iteration on evidence:** The top rungs are retention, which means fixing what the first dozen users hit. You learn what to build from what they do, not from what they say.
  </TabItem>
  <TabItem label="Challenges" icon="puzzle">
  ...
  <TabItem label="Requirements" icon="approve-check-circle">
    ...
    - **A recruitment channel by winter:** Strangers take months to find. The channel (a subreddit, a Discord, a campus group, an itch.io page) is a workstream with its own backlog items, not a message you send in week 9. The [Shipping guide](/guides/shipping/#new-product-or-game) maps the whole year.
  </TabItem>
</Tabs>
