...
We aim for teams of 3 to 4 students. Actual team sizes range from 2 to 5 or more, depending on enrollment and project needs.

We require each team to have at least one experienced "external partner".

Some categories have a project partner by definition (Research, Consultancy), but they might not be technical enough. In that case, consider getting a faculty or industry mentor that has the technical acumen to guide you.
...
Team up with friends. While familiarity can be an asset, productivity may sometimes be challenging to maintain. You can maximize your chances to be paired up with your friends during the project selection survey in week 0 of Fall term. You'll need to choose the same projects in the same order of preference. **This is by no means a guarantee.** We have a large number of students and projects, so it is not always possible to accommodate all requests. Shared Interests (see below) is the preferred way to form teams.

The best way to ensure you are on the same team as your friends is to form your own team and **propose a project together before the term starts**.

## Shared Interests

Form a team with classmates who share your interests. Though initial effort is required to establish connections, this approach can yield high productivity and rewards. This is the default way of creating teams, based on your prioritized list of projects in the survey. Instructors will do their best to put you on your top choices, but this is by no means a guarantee.
...
Every year, some students end up changing teams or working on their own. The latter is mostly a way for them to *not* fail the class, and will involve close instructor supervision and a lot of effort.
