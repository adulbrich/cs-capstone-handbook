...
The Capstone instruction team has a couple of AWS accounts available. Upon approval, students can either receive access to one of these accounts for the duration of the academic year, or get some services running (e.g., Helix Core Version Control). These accounts have budget limits and are wiped at the end of the year. Access is subject to approval.
