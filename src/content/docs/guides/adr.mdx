...
For this course, ADRs are not optional bookkeeping. Your `docs/adr/` directory is checked at the [repo checkpoints](/assignments/repo-checkpoints/), and your [RFC](/assignments/rfc/) has its second life here: the proposal argues for a decision, and once the team makes it, the record of what was decided and why belongs in an ADR.
...
- Team discussion notes, fall week 3
```
...
week a checkpoint is due, about decisions they made months earlier. Those
...
try it abandon the practice by winter, which leaves them with no records at all.
...
instinct is often right: an imperfect decision made in week 3 usually beats a
perfect one made in week 8, because you learn from the thing you built. The
...
their value is hard to feel while writing them. The audience is your winter self,
your successor team, and the partner who asks in spring why the system works this
way. None of them can ask you a follow-up question, which is exactly why the
...
are there so you can pick one rather than inventing your own in week 3.
