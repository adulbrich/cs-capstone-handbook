...
The format comes from [Michael Nygard's 2011 post](https://www.cognitect.com/blog/2011/11/15/documenting-architecture-decisions), which is worth reading in full because it is about two pages and makes the case better than any summary. His observation was that architecture documents go stale because they describe a system that keeps changing, while decisions do not change: a decision made in the fourth week of a project was still made then, even after you reverse it three months later. So record the decisions, timestamped and immutable, and let the current state of the system be read from the code. That reframing is the whole idea.
