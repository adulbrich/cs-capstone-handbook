...
- [User Story Mapping](https://www.nngroup.com/articles/user-story-mapping/), Nielsen Norman Group: the technique behind the fall workshop, and how a horizontal line becomes a release.
...
- [Identify Success Metrics](/activities/planning/#identify-success-metrics): the fall workshop, with a variant per outcome type.
- [Dependency Mapping or Critical Path Analysis](/activities/planning/#dependency-mapping-or-critical-path-analysis): the workshop that finds what has to happen first.
