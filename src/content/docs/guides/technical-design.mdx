...
<LinkCard
  ...
  description="The workshop activity that produces the architecture diagram for docs/design.md and your RFC."
/>
...
- **The diagram is still true**: if the architecture drawing and the code disagree at a checkpoint, the document has stopped being read.
...
- [Describe your Architecture](/activities/design/#describe-your-architecture): the fall workshop that produces the diagram this guide is about.
