...
<LinkCard title="Faculty and Student Capstone Information" href="https://engineering.oregonstate.edu/events/expo/capstone" description="Instructions, schedule, guidelines for the Engineering Expo." />
...
If you need special accommodations for the event (such as monitors, power sources, proximity to another team), please reach out to your instructors or the Expo organizers in advance.

## Expo Poster

All teams attending the in-person event must create a poster to display at the Expo. 
...
Only when your received a **final approval** from your instructor, you can send your poster for printing. **Don't miss the deadline for printing.**
