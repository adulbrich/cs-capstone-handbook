...
that in advance so you do not start from a blank page in the last week of the
term. The effort is in reconstructing what happened, not in the writing. Teams
that keep a running note through the term, even a short one per sprint, produce a
...
retrospective-shaped memory exercise in week 10.
