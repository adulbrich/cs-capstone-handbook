...
behavior; decisions and their reasons are in docs/decisions/.
...
The last line is the part your [Team Charter](/assignments/team-charter/) calls the confidentiality one-pager, spelled out for the tools. The human-readable version, one page in the repository, says the same thing in the partner's terms:
...
Verified students get the free **GitHub Copilot Student** plan. Activate it at [GitHub Education](https://github.com/education). It gives you unlimited code completions plus limited chat and agent usage in VS Code, JetBrains, and other editors, with an allowance of AI credits and automatic model selection rather than a model picker. GitHub re-checks your eligibility every month. This replaced the older "free Copilot Pro for students" offer in March 2026; verified teachers and open-source maintainers still get Copilot Pro. If you do not have another preferred tool, Copilot is a solid default.
:::
...
- **Midjourney**, **Stable Diffusion**, **GPT Image** (the model behind ChatGPT Images, which replaced DALL-E when OpenAI retired it in May 2026), **Google Gemini image generation**: image generation for mockups, assets, or diagrams. Check licenses before using generated assets in your project.
