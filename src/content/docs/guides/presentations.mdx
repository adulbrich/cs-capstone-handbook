...
- Says plainly what was descoped, delayed, or changed, and explains why.
...
Treat hard questions as help, not attacks. A design review that produces no changes is either a very mature design or a review where nobody raised a real objection.
...
You do not need perfect answers. "We considered that and chose not to because..." or "We do not know yet, and here is how we plan to find out" are credible responses. What damages trust is being caught without having thought about it at all.
...
Sprint demos on a student project are a partial simulation and everyone in the room knows it. In industry the audience controls a budget and can kill the feature; on a student project the audience is judging how you work and has already committed to the project continuing. That changes the incentives in a way nobody says out loud: the full disclosure that would cost you a feature at work costs you very little here, which makes this a cheap place to practice a habit that is expensive to learn later. Use it that way rather than treating the demo as a performance review.
