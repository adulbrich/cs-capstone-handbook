...
{/* TODO: add card link to requirement activities */}
...
Using a spreadsheet or a requirements management tool can help organize and track requirements throughout the project lifecycle. [GitHub Projects](https://github.com/features/issues) or [Linear](https://linear.app/) are great options.
:::

{/* TODO: add card link to planning activities */}
...
{/* TODO: link card to planning activities again */}
...
{/* TODO: not always true, specifically for hardware projects */}
