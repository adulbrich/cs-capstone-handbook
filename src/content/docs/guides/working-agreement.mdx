...
- **Minimum deliverables**: the course sets the floor, one reviewed pull request per student per sprint (see [Sprint Notes](/assignments/sprint-notes/)); the agreement can raise it and says how the board shows it.
