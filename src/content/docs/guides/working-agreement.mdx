...
Teams work better when everyone knows who to go to for what. This does not mean rigid hierarchy; it means clarity. Three rotating roles cover most of what a small team needs: a Project Manager who owns the schedule and the partner relationship, an AI Coordinator who owns the shared tool configuration and the confidentiality rule, and a Quality Owner who owns the definition of done and the state of the build. Name them once, in one place, rather than letting a second informal set grow alongside. Coordination work the three roles do not cover (documentation currency, facilitating stand-ups and retrospectives) should still be assigned explicitly and rotated by sprint or term, rather than falling on one person by default.
