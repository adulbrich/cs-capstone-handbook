...
- Instrument before you need the numbers. Analytics wired in fall is evidence in spring; analytics wired in May is a screenshot of an empty chart.
- Treat recruiting strangers as a workstream: an owner, a channel that exists, backlog items, starting in winter.
- Put dates earlier than March in your Definition of Shipped, and renegotiate the rung in the open when they slip rather than discovering the slip in June.
...
- Evidence collected in the moment costs minutes; evidence reconstructed in June is the kind the [Release and Metrics](/assignments/release/) page cannot credit. Screenshot the milestone the day it happens.
