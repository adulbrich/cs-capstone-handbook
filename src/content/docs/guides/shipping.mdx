...
**The ladder:** from the bottom, partner feedback on a prototype; that feedback addressed in a newer version; the partner actively integrating a public-facing or operations-critical system into production; and that system in production ([the Consultancy ladder](/assignments/project-partner-evaluation/#verification-and-validation)). Read the top rungs carefully: they describe actions the **partner** takes, not you. Your job is to make those actions easy, safe, and early.
