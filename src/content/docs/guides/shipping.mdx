...
Your spring grade's largest partner-evaluation facet, Verification and Validation, is scored against **outcomes**: merged upstream, in production, reproducible, in real use. Each project category has its own [outcome ladder](/project-evaluation/project-partner-evaluation/#verification-and-validation), and the top rungs are hard on purpose.
