...
This guide supports the [Definition of Shipped](/assignments/definition-of-shipped/), the term gates in the [Repo Checkpoints](/assignments/repo-checkpoints/), the [Release and Metrics](/assignments/release/) submission, and the outcome ladder in the [Project Partner Evaluation](/assignments/project-partner-evaluation/#spring).
</Aside>
