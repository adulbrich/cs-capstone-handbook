...
- **Asking a partner beforehand:** some project descriptions invite you to contact the partner with questions. Asking doesn't reserve a spot; the instruction team places students.
- **External partner:** every team has one. Some projects arrive with one. For the rest, the team finds one or more mentors (faculty, industry professionals, or anyone who can move the project forward), approved by the instruction team, and a mentor's evaluation carries the same weight as a project partner's. Align expectations with them in your first meeting.
...
Each week's slot is a workshop, a guest speaker (industry, faculty, alumni who shipped something), a demo day, or no lecture at all. The [schedule](/introduction/schedule/) says which, what's due, and what to read first. Check Canvas for announcements, meeting times, and room.
...
**Changing teams** happens only when staying would be worse. If a concern is building, talk to your Teaching Assistant (TA) or your instructors as soon as possible. We recommend working through the [conflict guide](/guides/conflict/) first, because a problem raised early can often be fixed inside the team, and a transfer disrupts two teams. Reasons that have justified a change are a conflict mediation couldn't resolve, a skills mismatch large enough that you'd clearly contribute more elsewhere, and a multi-team project that needs its people rebalanced. Write to the instructors with the reasons and what you already tried inside the team; an instructor talks to everyone involved and decides. If the change is approved, both teams agree on a transition plan covering responsibilities, knowledge, and in-flight work, and the reasons, the decision, and the plan are written down. You're then assessed on your contributions to each team for the time you were on it, and the grade may be adjusted for the change's impact on both projects.
