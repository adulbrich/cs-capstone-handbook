...
Please note that [each category will be graded differently](/project-evaluation/project-partner-evaluation/#verification-and-validation), and some projects require more effort than others. Expectations can also be customized with your project partner.
...
You *cannot* approach this class as a regular, assignment-based class. If you tackle assignments last minute, you *will not excel in this class*. Each term, your grade combines four equal components: the project partner evaluation (25%), peer evaluations (25%), individual evidence such as RFCs and live defenses (25%), and team deliverables (25%). All graded work is documented in the [Assignments section](/assignments/introduction/) of this handbook, which Canvas mirrors.
