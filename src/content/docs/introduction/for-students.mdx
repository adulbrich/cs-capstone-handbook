...
- **Partner or mentor:** a project a partner submitted comes with that partner. A student-proposed project has a mentor instead (faculty, an industry professional, or anyone who can move the project forward). A partner who is not technical might also need a technical mentor, who advises the team while the partner still evaluates it; the instruction team can help find one. Align expectations with them in your first meeting.
