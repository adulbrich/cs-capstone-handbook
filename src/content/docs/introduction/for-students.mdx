...
Each week's slot is a workshop, a guest speaker (industry, faculty, alumni who shipped something), a demo day, or no lecture at all. The [schedule](/introduction/schedule/) says which, what's due, and what to read first. Announcements carry the meeting times and room.
...
Project funds and cloud access go through the instruction team; ask them for the request form.
