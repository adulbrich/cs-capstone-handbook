...
import ImageCarousel from '../../../components/Carousel.astro';
import { portal } from '/src/site';

Our CS Capstone students work in small [teams](/introduction/for-students/#how-you-get-your-project-and-team) over three terms (30 weeks). Here's a sample of projects that have been built in the past few years. Not all projects are open-source, and some are multi-year projects that will be updated in the future.

:::note[The current catalog lives on the project portal]
The <a href={portal.home}>project portal</a> lists every published project, including archived ones from past years. This page keeps a few highlights.
:::
...
<Badge text="React" variant="tip" class="my-6" size="small"/>
<Badge text="Vite" variant="tip" class="my-6" size="small"/>
<Badge text="Google Firebase" variant="tip" class="my-6" size="small"/>
...
![Lavender dashboard showing sleep entries, schedules, and sleep quality trends](../../../assets/2024-lavender.png)
...
<Badge text="3D Graphics" variant="success" class="my-6" size="small"/>
<Badge text="Unreal Engine" variant="tip" class="my-6" size="small"/>
...
import imageRobotUnderground1 from '../../../assets/2024-robot-underground-1.png'
import imageRobotUnderground2 from '../../../assets/2024-robot-underground-2.png'
import imageRobotUnderground3 from '../../../assets/2024-robot-underground-3.png'
import imageRobotUnderground4 from '../../../assets/2024-robot-underground-4.png'

<ImageCarousel images={[
  { src: imageRobotUnderground1, alt: '3D Robot Next to a Cube' },
  { src: imageRobotUnderground2, alt: '3D Arduino Board' },
  { src: imageRobotUnderground3, alt: 'Code Editor' },
  { src: imageRobotUnderground4, alt: 'Unreal Engine Editor' },
]} />
...
<Badge text="React Native" variant="tip" class="my-6" size="small"/>
...
![Ephira mobile app screens for logging cycle data and locking the app](../../../assets/2024-ephira.png)
...
<Badge text="New Product" variant="note" class="my-6" size="small"/>
<Badge text="Mobile" variant="success" class="my-6" size="small"/>
<Badge text="Flutter" variant="tip" class="my-6" size="small"/>
<Badge text="Google Firebase" variant="tip" class="my-6" size="small"/>

Corvallis Connect is a civic engagement mobile application that empowers residents of Corvallis, Oregon to easily report issues directly to the city: potholes, broken streetlights, public safety concerns, and more.
...
<Badge text="New Product" variant="note" class="my-6" size="small"/>
<Badge text="Web" variant="success" class="my-6" size="small"/>
<Badge text="Go" variant="tip" class="my-6" size="small"/>
<Badge text="TypeScript" variant="tip" class="my-6" size="small"/>
<Badge text="Postgres" variant="tip" class="my-6" size="small"/>
<Badge text="Docker" variant="tip" class="my-6" size="small"/>
<Badge text="RabbitMQ" variant="tip" class="my-6" size="small"/>
...
![NextJudge competitive programming platform problem view (dark theme)](../../../assets/2023-nextjudge-dark.png)
</div>

<div class="dark:hidden">
![NextJudge competitive programming platform problem view (light theme)](../../../assets/2023-nextjudge.png)
</div>
...
<Badge text="Svelte" variant="tip" class="my-6" size="small"/>
...
![The Unknown Venome web interface showing a 3D venom protein structure](../../../assets/2023-venome.png)
...
<Badge text="Visualization" variant="success" class="my-6" size="small"/>
<Badge text="Unity" variant="tip" class="my-6" size="small"/>
...
<div class="flex justify-center">
  ![Student wearing a VR headset exploring a 3D animal anatomy model](../../../assets/2023-immersive-animal-anatomy.jpg)
</div>
...
The [Immersive Animal Anatomy Visualizer](https://extended-reality-lab.github.io/projects/immersive-animal-anatomy-visualizer) is distributed via the Oculus App Lab, which means updates can be easily downloaded by users like any other application on the Oculus Quest 2. 
...
<Badge text="PyTorch" variant="tip" class="my-6" size="small"/>
<Badge text="Jupyter" variant="tip" class="my-6" size="small"/>

Using machine learning to turn unreadable or missing satellite images into usable and rich data.

![Side-by-side satellite land surface temperature images comparing model outputs](../../../assets/2023-sttfn-osu.png)
