...
Our CS Capstone students work in small [teams](/practicalities/teams/) over three terms (9 months). Here's a sample of projects that have been built in the past few years. Not all projects are open-source, and some are multi-year projects that will be updated in the future.
