...
:::note
For New Product or Game, you will need to show that you have active users or a rigorous user study. To achieve either one, you will need to combine many of the activities below.
...
Write a summary of the outreach you've done and the mediums you've used, and the returns, e.g., people who have agreed to do user activities with you. Consider the following marketing activities:
...
Once you've found a good pool of users, engage them to gather feedback on your product. This can be done through social media posts, emails, surveys, demos, a public Discord/Slack channel, etc. 
