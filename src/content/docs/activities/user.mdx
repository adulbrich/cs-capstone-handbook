...
:::note
These activities are direct preparation for the hardest part of most projects: getting a real person in front of the thing. Any realistic plan for shipping needs a **user access plan**, naming who your real users or evaluators are and how you will reach them before you need them. Recruiting users takes weeks, not days; the [Shipping guide](/guides/shipping/) explains the lead times, which is why these activities start early.
...
There are dozens of activities that you can do with *real* users (see previous section). Select one that is relevant for your project at this point in time and do it. This is exactly the kind of evidence that shows real people used the thing, rather than that you meant them to.
...
Get human-subjects approval filed while there is still a year left to use it. A few hours to draft, then weeks of review you do not control, so start in your first week.
