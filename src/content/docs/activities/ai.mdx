...
A good output is a list where the one-way doors are few. If you classified eight of ten as one-way, you have not made the distinction, you have just labeled everything important.
...
Several of these *are* the net rather than a convenience: a separate architectural-review pass and a code-review pass are safety-net components, and a plan-before-you-build skill is what turns "make it do X" into the kind of specification a design document can be written from.
