...
2. **Delegation limited by checks**: delegate only as far as your tests, CI, and review would catch its mistakes. To delegate more, build better checks first.
