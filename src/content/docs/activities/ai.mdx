...
**No graded criterion in this course requires any of these tools.** What is assessed is the fit between how far you delegated and how strong a net you built. A student on a free tier who gates tightly and validates carefully is doing the harder work. Every activity below states its substitute for more limited tooling.
:::
...
In the workshop, the second half produces the same audit with an AI agent (a skill or a structured prompt) and sets it beside yours; the differences are the lesson, and either version can be the one you keep.
