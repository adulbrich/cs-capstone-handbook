...
Decide what "it worked" will mean, in numbers, while you are still far enough from the deadline to be honest about it. One to two hours as a team, once when you first commit to what shipping will mean, and again when the deadline is close enough to check the number honestly.
