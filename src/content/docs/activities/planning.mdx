...
Decide what "it worked" will mean, in numbers, while you are still far enough from the deadline that the result cannot sway you. One to two hours as a team, once when you first commit to what shipping will mean, and again when the deadline is close enough to check the number.
