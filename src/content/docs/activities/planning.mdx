...
Submit a list of at least three "How might we..." questions relevant to your project, along with a brief explanation of the challenge each question addresses.
...
Provide a completed Fishbone Diagram (hand-drawn and scanned, or created with a diagramming tool) for a key problem in your project, along with a short summary of the main causes identified.
