...
1. Low Effort, High Impact: Quick wins that should be prioritized.
2. High Effort, High Impact: Major projects that require planning but are worth pursuing.
3. Low Effort, Low Impact: Low-priority tasks, tackle if time permits.
4. High Effort, Low Impact: Usually not worth pursuing.

<div class="has-[img]:invert-0 has-[img]:dark:invert">
![](../../../assets/impact-effort-matrix.png)
</div>
...
4. Not Important Nor Urgent: Consider eliminating these tasks.

<div class="has-[img]:invert-0 has-[img]:dark:invert">
![](../../../assets/eisenhower-matrix.png)
</div>
...
1. High Value, Low Cost: Prioritize these “quick wins.”
2. High Value, High Cost: Worth investing in if resources allow.
3. Low Value, Low Cost: Consider doing if time permits.
4. Low Value, High Cost: Generally avoid or minimize these tasks.

<div class="has-[img]:invert-0 has-[img]:dark:invert">
![](../../../assets/cost-value-matrix.png)
</div>
