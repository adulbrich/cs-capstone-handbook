...
Decide what "it worked" will mean, in numbers, while you're still far enough from the deadline that the result can't sway you. One to two hours as a team, once when you first commit to what shipping will mean, and again when the deadline is close enough to check the number.
...
- **Commit it, dated, before you measure.** Choosing the metric after seeing results is how well-meaning people mislead themselves.
...
A good output is a short document outlining the agreed-upon Definition of Done for your project.
...
The [Shipping guide](/guides/shipping/) lists the lead times your release path involves.
