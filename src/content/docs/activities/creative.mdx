...
Creative activities generate ideas and help you figure out what to build. Frame and re-frame the problem as much as needed, then come up with as many solutions as possible before converging. This cycle of diverging and converging is often referred to as the [double diamond](https://www.designcouncil.org.uk/our-resources/the-double-diamond/) process.
...
These interviews also start your user access plan: the named people you can actually reach when you need real users.

A good output is the interview plan, notes from the interviews, and a reflection on how the book's approach changed your project.
...
Write a [literature review](https://owl.purdue.edu/owl/research_and_citation/conducting_research/writing_a_literature_review.html) of your research topic: a summary and analysis of the existing research, so you can name the gap your project fills and build on what's already known.
