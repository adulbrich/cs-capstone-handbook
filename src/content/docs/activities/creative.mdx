...
A good output is the interview plan, notes from the interviews, and a reflection on how the book's approach changed your project. These interviews are also the start of a user access plan: the named people you can actually reach when you need real users.
