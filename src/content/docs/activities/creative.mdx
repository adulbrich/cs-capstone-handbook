...
[IDEO's seven rules of brainstorming](https://www.ideou.com/blogs/inspiration/7-simple-rules-of-brainstorming), which extend the four Alex Osborn published in 1953:
...
Osborn's original four are the first three plus quantity; the last three are IDEO's additions for running the session well.

Tight on schedule? Consider [How to Brainstorm -- Remotely](https://hbr.org/2020/07/how-to-brainstorm-remotely).

Whatever methodology you select, capture a summary of the most promising ideas or solutions.
...
The name is the recipe: **6** participants, **3** ideas, **5** minutes. Each participant starts with a blank sheet, and you iterate for 6 rounds:

1. Each participant adds 3 ideas (within 5 minutes) to the sheet in front of them, building on what is already written.
2. Pass sheets one step around the circle.

Six rounds of six people produces 108 ideas in half an hour. Adjust the numbers to your team size; keep the structure.
