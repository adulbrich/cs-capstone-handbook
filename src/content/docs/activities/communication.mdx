...
The presentation activities on this page are direct preparation for your [Defense](/assignments/defense/) and for the demos in your [Sprint Notes and Demos](/assignments/sprint-notes/).
...
**Feeds:** the [Career and Individual Retrospective](/assignments/career-retrospective/) writing criterion.
...
**Feeds:** the [defense](/assignments/defense/) communication criterion.
...
**Feeds:** the [Release and Metrics](/assignments/release/) Trailer criterion.
