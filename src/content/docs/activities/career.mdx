...
The goal of Capstone is to set you up for professional success. The Career Preparation activities encourage you to polish your career skills from different perspective.
...
Improve coding skills by solving at lest three (3) problems on platforms like [LeetCode](https://leetcode.com/). 
