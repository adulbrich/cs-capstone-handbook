...
Improve coding skills by solving at least three (3) problems on platforms like [LeetCode](https://leetcode.com/). 
...
Polish and make one of your code repositories public (e.g., GitHub). Have your project reviewed by two (2) peers. Revisit your repository and its README based on their feedback.
...
Submit a summary of the hackathon experience, including the project developed (with screenshots or pictures if available), challenges faced, and lessons learned.
