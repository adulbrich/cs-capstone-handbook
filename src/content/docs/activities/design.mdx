...
Put your technical design in front of another team and review theirs in return, in one sitting; the [presentations guide](/guides/presentations/#design-reviews) covers what a design review is for. About 90 minutes for two teams in one room or on one call. With three teams, each presents to both others in turn, then each reviews the next team's page, all three reviews at once, which takes about 75 minutes.

- **Draw your design on one page**: 20 minutes. The components, how they connect, what they are built with, and the one design decision your team is least sure of. Cover the three issues below at the depth one page allows.
- **Present**: 5 minutes. Walk the other team through the page. Answer their questions; don't defend the design yet.
- **Review**: 20 minutes. The other team works through the questions below and writes down each finding in one sentence. Then swap roles and repeat.
