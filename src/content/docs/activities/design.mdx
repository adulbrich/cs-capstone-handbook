...
Write a [test plan](https://en.wikipedia.org/wiki/Test_plan) for the paths that must work before real users arrive, not for every feature. One to two hours as a team.

1. Identify Test Objectives: List the paths that must work (signing in, saving data, a payment) and what you need to test on each (e.g., functionality, usability).
...
Put your technical design in front of another team, who doesn't share your assumptions, and review theirs in return, in one sitting; the [presentations guide](/guides/presentations/#design-reviews) covers what a design review is for. About 90 minutes for two teams in one room or on one call; three teams reviewing in a ring take about half an hour more.
...
The page covers these three issues:
