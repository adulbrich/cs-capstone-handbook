...
A good output is a diagram of the architecture and a brief explanation of each component and its role in the system. This diagram belongs in your repository docs, and it anchors the design section of an RFC.
