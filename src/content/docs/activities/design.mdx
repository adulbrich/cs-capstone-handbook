...
See the [Shipping guide](/guides/shipping/) for the lead times your deployment path involves.
...
Two other teams review your technical design and you review theirs, in writing, so nobody has to be in the same room at the same time; the [presentations guide](/guides/presentations/#design-reviews) covers what a design review is for. Two to three hours in total, once per design cycle, spread over a few days.

- **Write your packet**: a one-page diagram and one page of text covering the three issues below, shared with the two teams reviewing you.
- **Review the other two packets**: for each, answer the questions below in writing, then open the repository and check that the code implements the design.
- **Read the reviews you received**: decide what changes in your design, and write down what you changed and what you declined, with a reason.
- **Talk it through (optional)**: if you disagree with a review, a 20-minute call with the reviewing team once the written reviews are in, to argue the points still open.

As a reviewer, think critically about the other team's design:

- Does the packet address the three issues below?
...
The review can be individual (one person from each team) or team (everyone reviews both packets, and the team consolidates one review per packet). Giving and receiving this kind of review is rehearsal for a formal RFC review round.

The packet covers these three issues:
...
A good output is your packet, the written review you gave each of the two other teams, and a note on what you changed in your own design after reading theirs.
