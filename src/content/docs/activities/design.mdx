...
Two other teams review your technical design and you review theirs, in writing, so nobody has to be in the same room at the same time. Two to three hours in total, once per design cycle, spread over a few days.
...
- **Talk it through, if you disagree** (optional): a 20-minute call with the reviewing team once the written reviews are in, to argue the points still open.
