...
These exercises put conflict handling to work on a situation your team is actually in.

The explanation lives in the guide: what kind of conflict you're looking at, where it comes from, how to raise a contribution problem without wrecking the relationship, and when to escalate.
...
Find out how your team actually handles disagreement before you're in the middle of one, and agree which style fits which situation. One hour as a team, early, before the first real disagreement.
...
- **Take the [Big Five test](https://bigfive-test.com/)** individually. It's free and open source.
...
- **Write the three steps**: private one-to-one, raise at the retrospective, escalate to the Teaching Assistant (TA). Say who does step one, so it isn't left to whoever cracks first.
