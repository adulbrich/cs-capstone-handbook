...
<Badge text="Recommended" variant="tip" class="mb-6"/>
...
**Feeds:** the [Incident Postmortem](/assignments/incident-postmortem/) blameless criterion, which is largely a matter of language discipline.
...
![The Thomas-Kilmann matrix: five conflict-handling modes (competing, collaborating, compromising, avoiding, accommodating) plotted on two axes, assertiveness and cooperativeness](../../../assets/tki-matrix.png)
</div>
