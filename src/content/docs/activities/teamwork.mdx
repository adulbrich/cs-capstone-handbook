...
Teamwork activities work best when **all** team members attend. These exercises surface how the team actually functions, and a missing member is usually the person whose perspective the team most needs to hear. Professionally, showing up for team rituals is the baseline of dependability: teammates plan around your presence, and repeated absences erode the trust these activities are designed to build.
...
Capture a summary of the discussion, including the list of learning objectives, skills, and action items. This conversation is a natural input to your [Team Charter](/assignments/team-charter/).
...
Keep brief notes of key discussion points: important decisions made, challenges raised, and how they were addressed. These notes make writing your [Sprint Notes](/assignments/sprint-notes/) fast and accurate.

A good output is an agreed cadence and format written into your charter, plus a week of stand-ups actually held.

**Feeds:** every [sprint note](/assignments/sprint-notes/): get the cadence right and the note takes fifteen minutes.

## Two truths and a bug

<Badge text="Team Activity" variant="note" class="mb-6" />

Find out who you are actually working with, in the fifteen minutes before anyone opens a laptop. Fifteen minutes, once, when the team first sits together. The [working agreement guide](/guides/working-agreement/) covers the norms a team writes afterward, once it knows who it has.
...
- **Chase the interesting one**: whichever claim caused the most argument, ask for the story behind it. This is the part worth the time, and the part teams skip when they treat the exercise as a warm-up to get through.
- **End with a want**: one sentence each on what you most want to be better at by the time this project ends. Nobody collects these; you say them out loud so your teammates know what you are here for.

A good output is that every person can name something about each teammate that the roster does not say, and one thing each teammate wants to get better at.
...
A good output is your team's current stage named, with the specific strategies you will use to move to the next one.
...
In the workshop's second half, produce the same reading of the assessment with an AI agent (a skill or a structured prompt) and set it beside yours; the differences are the lesson, and either version can be the one you keep.
...
**Feeds:** the [defense](/assignments/defense/) role-and-team-accountability criterion, and the winter [Incident Postmortem](/assignments/incident-postmortem/).

## Team Health Assessment

<Badge text="Team Activity" variant="note" class="mb-6" /> <Badge text="Workshop" variant="caution" class="mb-6"/>

Health checks are a structured input for your retrospectives: run one before a retro and the discussion starts from data instead of vibes. The formats below also work well as the basis for your [Term Retrospective](/assignments/term-retrospective/).
...
In the workshop's second half, produce the same reading of the health check with an AI agent (a skill or a structured prompt) and set it beside yours; the differences are the lesson, and either version can be the one you keep.
...
**Feeds:** the [Project Retrospective](/assignments/project-retrospective/) team-dynamics criterion.
