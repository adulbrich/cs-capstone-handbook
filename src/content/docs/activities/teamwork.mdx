...
description: Teamwork activities for your capstone project, including stand-up meetings and the three rotating assessments of team formation strategies, dysfunctions, and health that run as workshop activities.
sidebar:
  order: 9
---
...
In the workshop, the second half produces the same read of your team with an AI agent (a skill or a structured prompt) and sets it beside yours; the differences are the lesson, and either version can be the one you keep.

A good output is your team's current stage named, with the specific strategies you will use to move to the next one.

**Feeds:** the [Team Charter](/assignments/team-charter/) conflict-and-inclusion criterion, and the [defense](/assignments/defense/) role criterion.
...
In the workshop, the second half produces the same reading of the assessment with an AI agent (a skill or a structured prompt) and sets it beside yours; the differences are the lesson, and either version can be the one you keep.
...
In the workshop, the second half produces the same reading of the health check with an AI agent (a skill or a structured prompt) and sets it beside yours; the differences are the lesson, and either version can be the one you keep.
