...
They are also load-bearing for the graded work: your requirements live in the repository as continuously updated docs, and the user-facing ones determine whether real people can use what you build. Before running any interview-based activity on this page, read the [Mom Test cheat sheet](/the-mom-test-cheat-sheet.md); it is the difference between compliments and evidence. Then check the [Shipping guide](/guides/shipping/) to see where your requirements work is heading.
...
A good output is your Is / Is-Not table or list, with a short explanation of how this analysis will help keep your project focused and aligned. An explicit "Is-Not" column makes it much easier to state accurately, later, what you actually committed to ship.
