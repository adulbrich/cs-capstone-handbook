...
A good output is your completed Canvas with any additional information that might be useful to understand it.
...
After reading this [User Story Mapping](https://www.nngroup.com/articles/user-story-mapping/) article from the Nielsen Norman Group, create a comprehensive user story map for your project, and include an initial written set of epics and user stories. The map defines your use cases and scenarios.
