...
In the workshop, the second half produces the same story map with an AI agent (a skill or a structured prompt) and sets it beside yours; the differences are the lesson, and either version can be the one you keep.
