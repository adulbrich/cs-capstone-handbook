...
If working on this activity as a team, have each different person focus on a different set of stories. Indicate whether each user story is high or low level. 
