...
<AssignmentMeta submission="Team" due="Fall, week 2" weight="4% of the fall grade">
  Winter's charter refresh is part of the first [Repo Checkpoint](/assignments/repo-checkpoints/) of the term, and spring's closes the [Team Health Assessment workshop](/assignments/workshop-activities/#spring-1-item-1) in weeks 2 to 3; neither is a separate assignment.
</AssignmentMeta>
...
Name who holds each of the three rotating roles and when rotation happens (at minimum, once per term). These three names are the ones the [defense](/assignments/defense/) asks about; do not rename them in your charter:
