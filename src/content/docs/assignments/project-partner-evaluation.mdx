...
The pulse has its own scale, separate from the six facets that follow. Each answer converts to points, and the pulse score is the average of the items your partner answered.
