...
60     | **You watched it run on your real inputs** (a live demo, a recording, a maintainer's comment on a draft) **but nobody outside the team has operated it.**
50     | **Nobody outside the team has run it.**

**Your [Definition of Shipped](/assignments/definition-of-shipped/) does not replace the ladder. It makes your rung concrete.** The rungs are written generally because they have to cover every project in the cohort. Your Definition of Shipped says what your target rung means for your project: which environment, which users, which upstream, measured how. That is what your partner scores against in spring, and it is why you write it in winter, while there is still time to act on it.
