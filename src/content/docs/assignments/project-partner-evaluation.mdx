...
"Deployment" is read loosely: for a research project it means the code and artifacts are documented and reproducible, in the sense the [FAIR principles](https://www.gofair.foundation/fair-principles) set out; for a FOSS project it means the patches include every necessary change, documentation included, and work in the existing codebase without regression.
