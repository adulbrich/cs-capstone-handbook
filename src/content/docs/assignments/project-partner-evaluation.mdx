...
**Custom grading is for genuine deviation, not for restating the ladder.** If your project fits no category, or your partner's expectations differ from the ladder in kind rather than in detail, they can score on a custom scale of [50,100]. Agree that in the Definition of Shipped in winter, not in June.
