...
Your answers to each survey. Peer evaluations are done through a [Qualtrics](https://www.qualtrics.com/) survey sent by email; it closes on the schedule above and is not reopened. All answers are anonymous; results are shared with instructors only. Questions about grades go to the instructors directly.
