...
Real teams range from 2 to 5 or more ([Projects and Teams](/practicalities/projects-and-teams/#how-teams-form) has how they are formed). The score calculation below is normalized around a team of five and explicitly corrects for team size; it is applied identically to all team sizes that occur.
