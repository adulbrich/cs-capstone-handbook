...
Teams are formed at 3 to 4 students, but real teams range from 2 to 5 or more. The score calculation below is normalized around a team of five and explicitly corrects for team size; it is applied identically to all team sizes that occur.
