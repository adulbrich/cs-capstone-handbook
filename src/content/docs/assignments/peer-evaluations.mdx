...
:::caution
Not completing a peer evaluation scores 50% on that survey's share of the grade for the student who did not complete it. Your teammates' scores are unaffected.
:::
...
|---|---|---|---|
| 1. Quantity | Took a fair share every sprint and picked up slack when someone was blocked; the contribution line in every [sprint note](/assignments/sprint-notes/) names their reviewed work. | Did what was assigned, on time, most sprints; nothing beyond it. | Contribution lines empty, or written by a teammate on their behalf, for two or more sprints. |
| 2. Quality | Pull requests merge after few review rounds, arrive with tests, and rarely come back as bugs. | Work passes review after the normal back-and-forth. | Work is redone by others, or ships without tests and breaks things. |
| 3. Attitude | At every meeting on time, answers messages the same day, volunteers for unowned work, says early when blocked. | Attends, responds within a day or two, does what is asked when asked. | Misses meetings without notice, goes quiet for days, teammates route around them. |
| 4. Technical value | Owns a part of the system others depend on, and the team asks them when it breaks. | Contributes working pieces that fit; nothing others build on. | No technical contribution the team can point to. |

**Check before you rate.** Open the sprint notes and look for the contribution line each sprint; open the repository and count pull requests opened, reviews given, and issues closed by name; check meeting attendance against your team's notes. A rating you cannot connect to something you saw is a guess, and the instructor reads the comments against the same record.

For the **second task** [2], students distribute 100 points among team members, including themselves. Each member can receive between 0 and 100, but the total must equal 100. One must give oneself at least 100/N points, where N is the number of team members, to avoid an unrealistic "self-incrimination" requirement (on teams of two, this rule is relaxed and the distribution task carries less signal; the four criteria dominate).
...
The CATME dimensions are broader than the four criteria above and are rated on their own behaviorally anchored scale inside the survey; nothing extra to prepare. Its result is combined with the spring final survey by the instructors.
...
- [Team Dysfunctions Assessment](/activities/teamwork/#team-dysfunctions-assessment): the midterm comments; naming a problem before the survey does.
- [Team Health Assessment](/activities/teamwork/#team-health-assessment): the spring survey and CATME.
