...
| Team | Team Charter, 6 Workshop Activities, 4 Sprint Notes, 2 Repo Checkpoints (ending with "hello, production"), Term Retrospective | Definition of Shipped, 1 Workshop Activity, 4 Sprint Notes, 2 Repo Checkpoints (ending with a release candidate and real-user evidence), Incident Postmortem | 1 Workshop Activity, 3 Sprint Notes, Release and Metrics, Landing Page, Project Handoff, Project Retrospective |
