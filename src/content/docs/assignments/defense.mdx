...
<AssignmentMeta submission="Individual, held as a team session" due="Weeks 7 to 9, every term" weight="10% of the term grade" />

Once per term, your team's [cohort check-in](/assignments/introduction/#cohort-check-ins) (weeks 7 to 9; your TA publishes the schedule) becomes a defense, during which **each student** walks through something they own and answers live questions. The session is **six minutes per student plus about ten minutes for setup and wrap**, so a team of three runs a little under half an hour and a team of five runs about forty minutes. Per-student time does not shrink on a larger team; the session simply runs longer. Sick or absent that week? Tell your TA before the session and you will be rescheduled, per the [absence policy](/assignments/introduction/#late-work-absence-and-makeup).
