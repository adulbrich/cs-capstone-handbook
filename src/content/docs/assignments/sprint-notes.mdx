...
At the end of every two-week sprint (the [sprint guide](/guides/sprint/) covers the cadence itself), the team submits a **one-page** sprint note and demos working software. The note is evidence plus judgment, not prose: if your repository and board are in order, producing it takes 15 minutes.
