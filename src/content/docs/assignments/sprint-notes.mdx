...
Two **all-hands demo days** per term, around weeks 5 and 10, put a sampled lineup in front of the whole class with partners invited. These are not assessed. Seeing what other teams built is good for morale and occasionally changes what you decide to build next.
