...
The **all-hands demo days** (the [schedule](/introduction/series/) has the weeks) put a sampled lineup in front of the whole class with partners invited. These are not assessed. Seeing what other teams built is good for morale and occasionally changes what you decide to build next.
