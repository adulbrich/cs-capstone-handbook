...
Presently, we recognize five main categories.
...
<Tabs syncKey="trio">
  <TabItem label="Benefits" icon="rocket">
    - **Deep Tech Skills:** Enhance your technical expertise by engaging with complex, cutting-edge projects.
    - **Solve Hard Problems:** Develop your problem-solving skills by addressing some of the toughest tech challenges.
    - **Impressive Portfolio Pieces:** Working on advanced projects can greatly enhance your professional portfolio.
  </TabItem>
  <TabItem label="Challenges" icon="puzzle">
    - **High Complexity:** The technical demands here are higher than typical projects and require a strong grasp of the subject.
    - **Integration Issues:** Merging multiple advanced technologies can be particularly challenging.
    - **Few Guidelines:** Innovative projects mean fewer existing examples to guide you.
  </TabItem>
  <TabItem label="Requirements" icon="approve-check-circle">
    - **Advanced Technical Skills:** Bring a robust understanding of the technologies related to your project.
    - **Innovative Thinking:** Employ creative and original thinking to tackle complex technical challenges.
    - **Collaborative Abilities:** Work effectively within teams, often across different disciplines, to solve intricate problems.
  </TabItem>
</Tabs>
