...
## Fall & Winter Terms Rubrics

<Badge text="CS461" variant="success" class="mb-6"/>
<Badge text="CS462" variant="success" class="mb-6"/>

For Fall and Winter terms, project partners evaluate teams based on **progress and development** rather than final outcomes. These adapted rubrics focus on growth, learning, and milestone achievement.
...
Points | Criteria
-------|---------
100    | Excellent communication with project partner. Regular updates, clear explanations, responsive to feedback.
90     | Good communication with minor gaps. Regular updates with mostly clear explanations.
80     | Adequate communication. Some gaps in updates or clarity of explanations.
70     | Limited communication. Irregular updates or unclear explanations.
50     | Poor communication. Minimal updates or consistently unclear communication.

## Spring Term Rubrics

<Badge text="CS463" variant="success" class="mb-6"/>

The following rubrics are used for **final project partner evaluation in Spring term (CS463)** and focus on ultimate project outcomes and deliverables.

For the Verification & Validation facet, the grading scale is different depending on the project category. If your project does not fit any category or if your project partner has other expectations, they will be able to provide a custom grade on the scale [50,100].
...
In addition to the general rubric for teamwork, we're also using the Comprehensive Assessment of Team Member Effectiveness (CATME). The [CATME Five Teamwork Dimensions](https://info.catme.org/features/catme-five-dimensions/) will only be used for intra-groups peer reviews, and not with your project partner:
