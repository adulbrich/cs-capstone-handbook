...
Every term, your project partner will evaluate you on the six facets using the rubrics below, either through Canvas assignments or a survey. **You should discuss expectations at the beginning of each term.**
...
Note that each facet will have a different weight depending on the term, see the [grade distribution](/project-evaluation/breakdown).

All Canvas assignments will have dedicated, specific rubrics that assess the learning objectives and accreditation requirements of the course. Refer to Canvas for more details.
