...
The project partner will evaluate the student team on different facets using the rubrics detailed on the [Rubrics page](/project-evaluation/rubrics/). The emphasis on each facet changes throughout the year to reflect project progression:
...
- If you change projects during the series, we won't adjust the distribution accordingly, and you'll likely need extra effort to meet expectations and achieve a good final grade.
- The project partner assessment facet distribution above applies specifically to **project partner evaluations**, which represent 25% of your total grade.
