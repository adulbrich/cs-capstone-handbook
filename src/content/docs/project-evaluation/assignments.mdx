...
> Each team member should complete at least [two requirements activities](../../activities/requirements) and [one planning activity](../../activities/planning) that help figuring out the requirements. Activities can be done as a team or individually (see specific activity for details).
...
Your requirements must be shared with and reviewed by your project partner. It's one of the key piece of documentation for the duration of the project. Keep it up to date, even when big changes are necessary (e.g., project pivot because lack of product-market fit).
...
Working for a company will add a whole new set of constraints to your project. Here are some questions worth considering whn talking to your project partner:
...
- What infrastructure will be used (cloud, on-premise)? What deployment processes and tools will be required (e.g., CI/CD pipelines, containerization)?
...
Put together an exhaustive document with your (software) design. You are free to organize your document in the best way you see fit to communicate to your audience (your project partner or mentor and the team). We encourage you to use visuals and tables wherever useful. You might not have all the answers just yet for the submission deadline, so you'll need to be clear about what is missing, what still needs to be refined, and so on. You'll have the opportunity to submit a revision in 463.

Your design document must be shared with and reviewed by your project partner. It's another one of the key piece of documentation for the duration of the project. Keep it up to date, even when big changes are necessary (e.g., project pivot because lack of product-market fit).
...
- What deployment environments are required (e.g., cloud, on-premise)?
...
At the end of each term, you will evaluate your teammates on their contributions to the team's success. This feedback is important for fostering a productive and collaborative work environment. You will receive a survey from the instruction team asking you to grade each team member based on the [teamwork rubric](../../project-evaluation/rubrics/#teamwork).

:::caution
This assignment could well tank your grade if you team feel like you did not contribute to the team's success. If there are conflict within the team, consider addressing them *early*, for example doing a [teamwork activity](../../activities/teamwork) that helps you figuring things out before it's too late.
:::
...
- How well did your or your teammate collaborate and support the team's efforts?
...
:::caution
Please note that the rubrics change every term, as more emphasis is put on different aspects of the project. In Fall, you will already be judged on the design, implementation, delivery, and outcome, not only requirements, because we want you to come up with a early prototype. This is the only option to get an "A" in Fall.
:::

As the academic year progresses, different weights will be assigned to each facets; see rubrics for details. 
...
It is highly recommended to present your demo to your project partners or mentors by the end of the term. This will give your another opportunity to receive feedback and to showcase your progress. Don't forget that a big part of your grade comes from their evaluation every term.
...
At the end of both the Fall and Winter terms, you will conduct a team retrospective to reflect on your progress and teamwork. For CS463, you'll have an [exhaustive project retrospective](./#project-retrospective). 
