...
{/* TODO: revisit this whole page
     ...
     */}
{/* TODO:
    - export all key assignments from Canvas
    - ask GenAI to summarize each of them
    - phrase it for project partners */}

import { Badge } from '@astrojs/starlight/components';

:::caution
This page is under heavy revision for the upocoming academic year (2025-2026). It will be updated as we finalize the assignments and their requirements.
:::
...
What evidence have you or will you collect to demonstrate that the objective has been met? Note that this will change depending on your [project category](/project-evaluation/project-partner-evaluation/#verification-and-validation).
...
At the end of every term, your project partner or mentor will receive a survey asking them to grade your team using the [project partner rubrics](/project-evaluation/project-partner-evaluation/).
