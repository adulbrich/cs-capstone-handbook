...
Here's the assignment matrix for each term.
...
:::note
The design document is a key summative assessment of your CS Capstone course, and is happening early in CS 462. This document should be reviewed regularly and re-submitted in Spring with a changelog and reflection, if any. You should probably start working on it in Fall.
:::
...
:::caution
The demos are key summative assessments of your CS Capstone course, and happen every term. Please note that the rubrics change every term, as more emphasis is put on different aspects of the project. In Fall, you'll already be judged on the design, implementation, delivery, and outcome, not only requirements, because we want you to come up with a early prototype. This is the only option to get an "A" in Fall.
:::
