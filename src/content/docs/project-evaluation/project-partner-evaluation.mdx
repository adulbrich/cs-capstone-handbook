...
| Individual work log sections in progress reports | Self-reported and team-reported sprint-by-sprint contributions with links |
| Repository activity | Commits, pull requests, code reviews, and issue ownership |
| Assignment attributions | Authorship of individual sections in submitted documents |
