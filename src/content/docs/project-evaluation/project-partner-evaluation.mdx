...
This page covers **project partner evaluations**, which account for 25% of each student's total grade each term, split as follows:
...
In addition to the partner's view of teamwork, students evaluate each other directly every term, and the end-of-spring survey uses the CATME Five Teamwork Dimensions. See [Peer Evaluations](/project-evaluation/peer-evaluations/).
