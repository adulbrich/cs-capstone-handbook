...
In Spring, the grading scale is different depending on the project **category**. If your project does not fit any category or if your project partner has other expectations, they will be able to provide a custom grade on the scale [50,100]. The spring evaluation is scored against the [Definition of Shipped](/assignments/definition-of-shipped/) your team agreed with the partner in winter, so **set expectations with your project partner early and keep them current.** The [Shipping guide](/guides/shipping/) maps the path to the top rungs for each category.
...
| Repository activity | Commits, pull requests, code reviews, and issue ownership (Track B teams: verified live at the walkthrough or [defense](/assignments/defense/)) |
