...
filename <- "data/2026-06-11-pp-survey-values.csv"
...
dt[Q6 == 1, Verification := 40]
dt[Q6 == 2, Verification := 36]
dt[Q6 == 3, Verification := 32]
dt[Q6 == 4, Verification := 28]
dt[Q6 == 5, Verification := 20]
...
fwrite(
    ...
    "data/2026-06-11-pp-survey-processed.csv",
    row.names = FALSE
)
