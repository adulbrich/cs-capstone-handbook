...
filename <- "data/2025-12-11-pp-survey-values.csv"
...
dt[Q6 == 1, Verification := 5]
dt[Q6 == 2, Verification := 4.5]
dt[Q6 == 3, Verification := 4]
dt[Q6 == 4, Verification := 3.5]
dt[Q6 == 5, Verification := 2.5]
...
fwrite(
    ...
    "data/2025-12-11-pp-survey-processed.csv",
    row.names = FALSE
)
